	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<br>
				<div class="btn_view">
					<el-button type="success" @click="addClick" v-if="btnAuth('yuyuejiaoshi','新增')">新增</el-button>
					<el-button  v-if=" btnAuth('yuyuejiaoshi','查看')" type="info"  :disabled="selRows.length==1?false:true" @click="infoClick(null)">详情</el-button>
					<el-button type="primary" :disabled="selRows.length==1?false:true" @click="editClick" v-if=" btnAuth('yuyuejiaoshi','修改')">修改</el-button>
					<el-button type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('yuyuejiaoshi','删除')">删除</el-button>
				</div>
			</div>
			<br>
			<el-table
				...
				<el-table-column label="审核" v-if="btnAuth('yuyuejiaoshi','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button type="info" v-if=" btnAuth('yuyuejiaoshi','查看')" @click="infoClick(scope.row.id)">详情</el-button>
						<el-button v-if="btnAuth('yuyuejiaoshi','咨询')" type="success" @click="zixunxinxiCrossAddOrUpdateHandler(scope.row,'cross','是','','')">咨询</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination 
		...
		<zixunxinxiFormModel ref="zixunxinxiFormModelRef" @formModelChange="formModelChange"></zixunxinxiFormModel>
	</div>
</template>
<script setup>
	...
	import zixunxinxiFormModel from '@/views/zixunxinxi/formModel'
	const zixunxinxiFormModelRef = ref(null)
    const zixunxinxiCrossAddOrUpdateHandler = (row,type,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
		...
		nextTick(()=>{
			zixunxinxiFormModelRef.value.init(row.id,'cross','咨询',row,'yuyuejiaoshi',statusColumnName,tips,statusColumnValue)
		})
    }
	//查询审核状态列表
