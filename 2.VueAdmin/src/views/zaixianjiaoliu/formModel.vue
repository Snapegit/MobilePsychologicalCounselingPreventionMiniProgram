...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.neirong = res.data.data.neirong?(res.data.data.neirong.replace(reg,'../../../cl21736250/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		context?.$http({
			url: `option/xinlijiaoshi/jiaoshigonghao`,
			method: 'get'
		}).then(res=>{
	...
	const jiaoshigonghaoChange=()=>{
		context?.$http({
			url: `follow/xinlijiaoshi/jiaoshigonghao?columnValue=` + form.value.jiaoshigonghao,
			method: 'get'
		}).then(res=>{
